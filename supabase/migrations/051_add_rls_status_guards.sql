...
ALTER TABLE IF EXISTS delivery_reports DROP POLICY IF EXISTS delivery_reports_update;
...
ALTER TABLE IF EXISTS delivery_reports DROP POLICY IF EXISTS delivery_reports_delete;
...
ALTER TABLE IF EXISTS defects DROP POLICY IF EXISTS defects_update;
...
ALTER TABLE IF EXISTS defects DROP POLICY IF EXISTS defects_delete;
...
ALTER TABLE IF EXISTS defects DROP POLICY IF EXISTS defects_insert;
...
ALTER TABLE IF EXISTS checklist_results DROP POLICY IF EXISTS checklist_results_update;
...
ALTER TABLE IF EXISTS checklist_results DROP POLICY IF EXISTS checklist_results_delete;
