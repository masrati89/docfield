...
export const DEFECT_STATUSES = [
  { value: 'open' as const, label: 'פתוח', color: COLORS.danger[500], backgroundColor: COLORS.danger[50] },
  { value: 'in_progress' as const, label: 'בטיפול', color: COLORS.warning[500], backgroundColor: COLORS.warning[50] },
  { value: 'fixed' as const, label: 'תוקן', color: COLORS.success[500], backgroundColor: COLORS.success[50] },
  { value: 'not_fixed' as const, label: 'לא תוקן', color: COLORS.danger[500], backgroundColor: COLORS.danger[50] },
] as const;

// Report lifecycle: draft → in_progress → completed → sent
export const REPORT_STATUSES = [
  { value: 'draft' as const, label: 'טיוטה', color: COLORS.neutral[400] },
  { value: 'in_progress' as const, label: 'בביצוע', color: COLORS.warning[500] },
